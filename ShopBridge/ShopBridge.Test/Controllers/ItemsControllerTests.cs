...
namespace ShopBridge.Test.Controllers
{
    ...
    public class ItemsControllerTests
    {
        ...
        {
            // Arrange
            _itemRepository.GetItemAsync(Arg.Any<string>()).Returns(Task.FromResult<Entities.Item>(null));
        ...
        {
            // Arrange
            _itemRepository.GetAllItemAsync(null).Returns(Task.FromResult(new List<Entities.Item> { _item }));
        ...
        private Entities.Item MockItemObject() => new Entities.Item
        {
            Id = 1,
            Description = "User1",
            Name = "User1",
        ...
        private IMapper MapperInitialize()
        {
            ...
            {
                opts.CreateMap<Entities.Item, Item>();
                opts.CreateMap<Item, Entities.Item>();
            });
